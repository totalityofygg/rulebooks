...
\begin{multicols}{2}
  ...
  \mybold{Caltrops, Handful}  Toss behind you to slow down pursuit. If you're using the rules for \mypg{getting chased}{arbiter-movement-die}, move your die \DCUP.
  ...
  \mybold{Grimoire (empty)} Holds 10 spells. Built to resist water and fire. See the section on \mypg{Grimoires}{grimoires} for more info.
...
\cbreak
  ...
  \mybold{Syringe} Jab Narcotics or sera into someone.  Philosophers and Pooka are fans.
