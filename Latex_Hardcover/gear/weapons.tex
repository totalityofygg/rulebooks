...
\mysection{Weapons}{gear-weapons}
 ...
 \goldcallout{
    ...
    \mybold{Trait} indicates the \mypg{Identity}{adventurer-identity} die you try to use the weapon.
    ...
    \mybold{\# Hands} indicates how many hands you need to have free to use the weapon (obviously), but also indicates the Burden of the weapon: \mybold{2h} weapons require 2 hands and have a Burden of 2; \mybold{1h} weapons require one hand and have a Burden of 1; and \OneHalf handed weapons require one hand but are only \OneHalf a Burden (so 2 Daggers would be 1 Burden, for instance).

    \hrulefill

    \mybold{Range} indicates what your threat range is.  Brawl weapons can only be used on Monsters Close to you; Throw weapons can be used on Monsters Close to you, or thrown Nearby; and Shoot weapons can target foes Nearby to Distant (but not Close).
    ...
    \mybold{Rarity} indicates the minimum size Settlement you would need to be in to find this weapon for purchase. See the section on Outlay for cost.
}
...
Weapons that require brute strength, most commonly used by \mylink{Sellswords}{trope-sellsword}
  ...
  \mytable{Y Y Y Y Y Y}{
    ...
    Unarmed & see Combat section & 2h & Brawl & Bashing & n/a \\
...
If you Crit with the weapon, the target gains \effect{Woozy} for \DUR{d4} unless they're wearing a helmet.
