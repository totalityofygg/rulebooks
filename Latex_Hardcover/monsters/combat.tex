...
\mybullet {
    \item A Monster may take a \mypg{Basic Maneuver}{combat-basic-maneuver}, like moving somewhere Nearby or taking cover;
    \item A Monster may attack an Adventurer, forcing them (the Adventurer) to make a Guard try; and/or
    \item A Monster may use an Innate ability that it has (see Monster descriptions below).
}

Attacking and using Innate Abilities are both Combat Actions. \mybold{Using either ends the Monster's turn in that Moment.}
...
The Monster can move from Nearby to Close and attack in a single Action. Charging attacks deal +4 damage if they hit, and end the Monster's turn (though see \mypg{Brace}{combat-tactical-maneuver-brace} under Combat).
...
\mybullet {
    ...
    \item  Any Adventurer deals 1 \HD of damage (meaning 3, 5, or 7 points of damage depending if the Monster's Power is Weak, Average, or Strong) in a single attack;
    \item  Any Adventurer succeeds in hitting with a \mypg{Gambit}{combat-deeds-gambit} ("I cut off the tentacle holding Sir Blibbilpoop!"). If the Gambit misses, the Adventurer who is being Grappled must make a Guard try or be struck themselves.
}
...
\example {
    A giant makes a grab at Fridge Largemeat, a knight of little renown - and Fridge fails his Guard roll.  The giant has a Throw of 30m.  Fridge rolls his \VIG (a d10) and gets a 7.  He is thrown 23m (30 - 7), so he'll take 23 damage(!) unless he makes an \RS try with one facet of his Identity and/or makes his \SAVE{Doom}.  See the section on \mypg{Falling}{movement-falling} for more info.
}
\cbreak

\myhighlight{Trample}{monster-action-trample}

The Monster can trample someone underfoot. If the Monster's attack succeeds, it subtracts 4 from its damage (minimum 1) and the Adventurer is knocked \effect{Prone}.
