...
\callout{\footnotesize{
  ...
  You are a renegade from the following Empire (Choose, or roll a d4):
   ...
   \myskip
    ...
    \mybold{Deep Janeen:}   You've worked the mazes and artworks of the Janeen.  If you are underground, you cannot get lost. You are Trained (d8,+1) in the \mypg{Skill: Veins Lore}{skill-veins-lore}. The Janeen only keep the most beautiful and interesting slaves - move your \PRE \DCUP. 

      \myskip

     \mybold{\AelfAdal} The never ending hate of the {\fontfamily{lmtt}\fontseries{b}\selectfont \bfseries{Ælf-Adal}} has burned out your empathy.  You are immune to: \effect{Disgusted} and \effect{Enraged}. If you ever need to try your \INSANITY, you only fail on a 1 (put a checkmark next to \INSANITY on your Adventurer Sheet so you don't forget).

      \myskip

     \mybold{Dvargir:}   You have participated in The Work, and now The Work is part of you.  You never tire and do not need to sleep unless you desire it (you must still rest in order to heal your wounds). You can carry +4 \mypg{Burden}{gear-burden}. Move your \TAL \DCUP.

      \myskip

     \mybold{dErO:}   You possess a partial congruity knot in your skull.  You are immune to: \effect{Befuddled}, \effect{Charmed}, and \effect{Slept}. You've got experience with dErO "machines" - you are Trained (d8,+1) in \mypg{Skill: Tinkering}{skill-tinkering}.
...
\cbreak
  ...
  You have lived your life in the darkness of the Veins, giving you \effect{Darksight}.
  ...
  The Fates smile upon you. Your \INJURY starts at Solid (d4) and your \INSANITY starts at Sober (d4). 
   ...
   \myhighlight{Killer}{murk-virtue-killer}
    ...
    You are Untrained (1) in the \mypg{Whispers of the Bride}{vulgate-whisper-the-bride}. This allows you to \mypg{Murder}{vulgate-whispers-murder} someone if you get \mypg{the Drop}{combat-drop} on them.
  ...
  You know the \mypg{Silent Speech}{atlas-languages}, the language of stones and rocks and the trade speech of the \mybold{Veins of the Earth}.  You can use this language to speak with stones. They can tell you what has touched them and what is under or behind them.  This makes it almost impossible to get lost underground. They're not great with time though ...
...
\newpage
  ...
  You are creature of Chaos, one of the \mypg{Unseelie}{the-inhabitants} - and are thus \mybold{Unhallowed}.
...
\cbreak
  ...
  You begin with:
      ...
      \mybullet {
        \item a suit of \mypg{Light Armor}{gear-armor};
    ...
    Under \mypg{Combat}{combat}, make sure you understand \mybold{the Drop}, a necessary part of the \mypg{Whispers of The Bride}{vulgate-whisper-the-bride}. Read up on the \mypg{Veins of the Earth}{atlas-veins-earth}.
