...
An \mybold{Adventure} consists of one or more Sessions. When your \mybold{Band} writes the last line of a chapter of their exploits, they complete an Adventure  (for example: Thundarr breaks the werewolf curse; Conan escapes the Demons of the Summit; Fafhrd and the Grey Mouser return to Lankhmar with Ohmphal's fingertips, etc.) More information on the Adventure can be found in the section on \mypg{Advancement}{advancement}, and under the Arbiter's Step of \mypg{Downtime}{downtime-arbiter}.
