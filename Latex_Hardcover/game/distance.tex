...
Like Time, Distance is broken into abstract lengths: \mybold{Close}, \mybold{Nearby}, \mybold{Far-Away}, and \mybold{Distant}.  These rules deal with distance in \mypg{Combat}{combat-movement-die}; larger distances are covered in the section on \mypg{Travel}{movement-travel}.  

You will also see mention of the \mybold{Movement Die}, written as \MD.  More information on the Movement Die can be found in the section on Combat; it is determined by the \mypg{Armor}{gear-armor} that you wear.
