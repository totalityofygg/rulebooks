...
By mastering the Crux of Blood, you bargain with the demonkind of Limbo to learn the \mylink{the Secrets}{arcana-wizardry-secrets} that lie beneath \mypg{the Arcana of Wizardry}{arcana-wizardry}, and manifest these Secrets using your \mybold{Blood Dice}.


\mysubsection{The Blood Die}{cruces-blood-dice}

The Blood Die is a \POOLD{d6} used to manifest \mylink{Secrets}{arcana-wizardry-secrets}. You must declare how many Blood Dice you are rolling before you invoke a Secret. If a Blood Die comes up a Failure (a 1 or a 2), it is immediately Spent.
...
\newpage
  ...
  \mytable{l X} {  
    ...
    1 &  A dripping ball of smoldering black sludge consumes your heart, burning a hole through your chest. You still live, but you are now \effect{Unhallowed}. \\
    2 &  Everything Nearby with a mouth must \SAVE{Doom} or vomit slick red fish for \DUR{d4}.  While vomiting they gain the \effect{Paralyzed}. \\
...
\newpage
  ...
  \mytable{l X} {  
    ...
    17 &  Luminous orange anemone fronds grow in and around your eye sockets, engulfing your eyes. You now possess the \effect{Darksight}. \\
...
\newpage
  ...
  \mytable{l X} {  
    ...
    11-12 &  You lift into the air and d4 limbs tear themselves away from your body. Flesh rips and tendons snap, you watch as the limbs dissolve in mid air as if being digested before you drop to the floor.  You fall down \mypg{Dying}{combat-dying} and are inflicted with \effect{Bleeding}. \\
