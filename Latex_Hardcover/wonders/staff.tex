...
All Magic Staves are 2-handed \DEX Bashing Brawl weapons that do d6 damage.  They can produce light at will (as a torch); can hit creatures only affected by magic weapons; and can dispel \mypg{Illusion}{secrets-illusion} with a touch (though this will prompt a \mybold{Wizard Fight!} if the opposing Philosopher is present).
...
\callout {
    \mybold{Novice Staff:} A Novice Staff can contain up to 3 Novice powers. Each Novice power requires you to spend 100\AU Novice powers take \mybold{Days} to bind to the implement. Requires the Virtue \mypg{Staff Magic: Novice}{adv-philosopher-staff-novice}.

    \myskip     

    \mybold{Warlock Staff:} A Warlock Staff can contain up to 3 Novice or Warlock powers.  Each Warlock power requires you to spend 1,000\AU Warlock powers take \mybold{Weeks} to bind to the implement. Requires the Virtue \mypg{Staff Magic: Warlock}{adv-philosopher-staff-warlock}.

    \myskip

    \mybold{Archmage Staff:} An Archmage Staff can contain up to 3 Novice, Warlock, or Archmage powers.  Each Archmage power requires you to spend 10,000\AU Archmage powers take \mybold{Months} to bind to the implement. Requires the Virtue \mypg{Staff Magic: Archmage}{adv-philosopher-staff-archmage}.
}

\mybold{Creating a Magic Staff takes Days, Weeks, or Months of \mypg{Downtime}{downtime-production}}
...
You may cast \mypg{Charms}{vulgate-charms} through your staff at will, as if you knew the Vulgate of Charms.

\myhighlight{Immunity}{staff-magic-immunity}

Choose one of the \mypg{Alignments}{arcana-wizardry-secrets-alignment}. As long as you are holding the staff, you are immune to any Secrets of that Alignment.
...
Your staff is covered with inscriptions in a weird language.  You gain +4 to any \mybold{Skill: Lore} rolls you try.
...
You may practice \mypg{Medicine}{vulgate-medicine} with your staff during Downtime, as if you knew the Vulgate of Medicine.
...
You may use your \INT (instead of \DEX) for your Guarding tries.


\myhighlight{Recklessness}{staff-magic-recklessness}

Once per Session, you may reduce the effects of a \mybold{Ruin}, \mybold{Calamity}, or \mybold{Mishap} (see \mypg{Crux of Blood}{cruces-blood-dice}) depending on the power of the Recklessness instilled in your Magic Staff:
...
This effect is in addition to any benefit you might receive from  \mypg{Virtue: Discordian}{philosopher-virtue-discordian}, \mypg{Virtue: Anarchist}{adv-philosopher-anarchist}, or \mypg{Virtue: Kallisti}{adv-philosopher-kallisti}.

\cbreak

\myhighlight{Runed}{staff-magic-runed}

Your Magic Staff has \mypg{Secrets}{arcana-wizardry-secrets} inscribed upon it. You may invoke these Secrets instantly using your Blood Dice, as if they were inscribed in your \mypg{skull}{arcana-wizardry-skull}. The number of Secrets depends on the power instilled in the Magic Staff:
...
You gain 2 extra \mypg{Research Pips}{research} that you may use when practicing \mybold{Chymistry} or \mybold{Inscription} during Downtime.
...
You only lose a Blood Die on a 1 (instead of a 1 or 2). This does \mybold{not} apply to Secrets performed by \mypg{Riding the Tiger}{cruces-blood-ride-the-tiger}.
