...
\mybullet {
    \item A \mypg{Wizard Sigil}{inscription-sigil-wizard} for each \mybold{Archaic Rune}
    \item A \mypg{Witch Mark}{occultism-witch-mark} for each \mybold{Fiendish Rune}
    \item A \mypg{Holy Writ}{miracle-holy-writ} for each \mybold{Seraphic Rune}
}
...
\mybold{Creating a Magic Sword takes Months of \mypg{Downtime}{downtime}}.
...
In addition to its normal damage, the weapon inflicts \effect{Bleeding} when it hits Flesh.
...
In addition to its normal damage, the weapon deals +d4 fire damage.  On a Crit, the victim must make a \SAVE{Doom} or become \effect{Enflamed} for \DUR{d4}.

\mybold{Infamous}

When the wielder kills a Monster with this sword, they can raise the sword above their head and bellow out their own name. The wielder makes a \RSTRY{\PRE}. On a success, all Close and Nearby Monsters must immediately make a \mypg{Morale try}{monster-morale}.
...
In addition to its normal damage, the weapon deals +d4 ice damage.  On a Crit, the victim must make a \SAVE{Doom} or be \effect{Paralyzed} for \DUR{d4}.
...
When you deal a killing blow with this weapon, every member of your Band wins Init at the top of the next Moment.
