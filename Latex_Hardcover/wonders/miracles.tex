...
\callout {
    Miracle Working can only be performed on the \mybold{Shopping Step} during \mypg{Downtime}{downtime}. Miracles are performed by sacrificing your Faith Dice (sacrificed dice are rolled if required, and removed from play); they must be performed on \mybold{Hallowed Ground} dedicated to your Small God, and you must be in possession of a \mybold{Holy Symbol} (Holy Relic, below). Each Miracle you perform \mybold{will cost you 100\AG per Faith Die sacrificed} for the appropriate vestments, relics, prayerbooks, sacred snakes, etc.  Miracles only take \mybold{Days} to perform unless otherwise noted.
...
Spend 1 Faith Die to create \UDD{d4} of Provisions. You can combine multiple \UD into a single \UD if you desire (see the section on \mypg{adding and splitting Resource Dice}{dice-asset}). These Provisions can be stored for use later. Anyone who partakes of these Provisions during a Bivouac receives the Sacrament of Bless (see the \mypg{The Vulgate}{vulgate}) in addition to the nourishment from the meal.
...
\mybullet { 
  \item You can give and take Faith from the Vassal as if they were a disciple (see the Legendary Mystic Virtue \mypg{Fishers of Men}{advancement-mystic-virtues} for more info).
  ...
  \item Your Vassal barely needs sleep, and eats and drinks sparingly (they do not need to roll Provisions when taking a Bivouac).
  \item Your Vassal gains +\DICE points of "holy armor".  Damage is subtracted from this total first before it is applied to Armor, Grit, etc.  It can't be healed, but can be restored by paying a visit to a Settlement and worshiping at an appropriate \mypg{Shrine}{gear-services-shrines}.
}

You and your Vassal can only have a single Covenant at any time.  The Covenant can be broken by one of you having a \mypg{Crisis of Faith}{cruces-faith-dice-recovery}; the death of you or your Vassal; or by mutual, peaceful agreement.
...
\mybullet { 
  \item Your Vassal can use their Faith as if they were a Sellsword's \mypg{Prowess}{sellsword-prowess}.  If they're already a Sellsword, they now have 2 Prowess they can roll together or separately.
  \item Your Vassal can gain Faith on their own (they don't need you to give it to them) up to a \MAX of 3.
  \item Your Vassal gains an additional +\DICE points of "holy armor" (see Covenant above).
}

You must name a \myital{jihad} important to your Small God: "wipe out the infidels of the Crawling Chaos", for example, or "bring the fingerbone of St. Sebastien to the reliquary in the Howling Wastes".  Similar to a \mypg{Geas}{occultism-geas}, any day not spent in the furtherance of the cause of the Crusade will lose your Vassal a single Faith die.  It's important to note that if you or your Vassal should suffer a \mybold{Crisis of the Faith}, the Crusade has failed and the Covenant is broken.
...
Golems requires a \myital{shem} - a slip of paper with a magical rune written on it through the miracle of the \mybold{Holy Writ}.

Golems are completely obedient to you and respectful of other followers of your Small God; presenting a \mybold{Holy Symbol} of your Small God is enough to keep them at bay, but only you can command them. If you should die, the golem will continue performing your last command in perpetuity.

\mybold{Golems are immune to the direct effects of any and all \mypg{Secrets}{arcana-wizardry-secrets}, though they can be indirectly affected}
...
\mynumlist {
    \item Smoke of Chaos:  Every creature in the smoke who does not worship your Small God must roll a d6: 1-2) they become \effect{Befuddled}; 3-4) they become \effect{Enraged}; 5-6) they become \effect{Afraid}.
    ...
    \item Smoke of the Holy: The ground covered by the smoke becomes \mybold{Hallowed Ground}; this can be used to temporarily create Hallowed Ground, or dispel \mypg{Unhallowed Earth}{occultism-unhallowed-earth}.  Unhallowed creatures within the smoke take 1 damage per Moment. 
    \item Smoke of Medicines: Every creature in the smoke who worships your Small God is immune to Disease and \INJURY
}}}
...
The Miracle of the Holy Relic is used to create \mybold{Holy Symbols}, a requisite for performing \mypg{Liturgies}{arcana-liturgies}.
...
Spend 1 Faith to write the word and the law of your Small God as seven sacred words on paper, papyrus, clay tablet, etc. Only you and other members of your faith can read the words; to others, they look like random squiggles, strange designs, or "primitive" carvings. A Holy Writ you create is unique, like a fingerprint or calling card. Unless you've seen a particular Holy Writ before, a \mybold{Skill: Lore} try is required to determine the owner of the Holy Writ. A Holy Writ may be transferred to another object or person; Unhallowed creatures marked by a Holy Writ are \mybold{Hallowed} for either 7 days or until the end of the Session (whichever comes first). Otherwise, the Writ is transferred permanently to the object or person, and can only be erased by the faithful who created it or by sprinkling it with a pinch of \mypg{Unhallowed Earth}{occultism-unhallowed-earth}.


\mysubsection{Incorruptibility}{miracle-incorruptibility}

This Miracle can be performed on a corpse to stop it from rotting.  The length of time depends on the number of Faith dice Spent (roll the dice before you Spend them):  1 die: \SUMDICE Days; 3 Dice: \SUMDICE Weeks; 5 Dice: \SUMDICE Years; 7 Dice: \SUMDICE Centuries; 9 Dice: \SUMDICE Millennia. So long as the body remains on Hallowed Ground, it does not decay in any way.  If the body is removed from Hallowed Ground, it will begin to decay as normal. While the body is in a state of incorruptibility, its soul will not depart from Limbo. The body is immune to any \mypg{Witchcraft}{arcana-witchcraft}.
...
Spend 1 Faith to create a cruet, chalice, paten, ciborium, etc. dedicated to your Small God:
    ...
    \mybullet {
        ...
        \item \mybold{Divine Oil:}  Oil poured into the Sacred Vessel can be used to anoint Mortal (not Unhallowed) beings. Anyone anointed with oil from the Sacred Vessel gains divine favor: once per Session, they may \mypg{Nudge}{dice-nudge} a die they've rolled to a different adjacent face. The effect ends when used, or at the end of the Session - whichever comes first. The Sacred Vessel can anoint up to 7 Mortals.
        \item \mybold{Hallowed Ground:}  As Hallowed Ground above. The Sacred Vessel may be used to hold Hallowed Ground until it is ready to be used.
}
...
Spend 1 Faith Die to remove the effects of a single \mypg{Madness!}{injury-insanity-madness} or \mypg{Curse}{cunning-curses} on a single Mortal (including yourself). You may Spend additional Faith Dice to heal more than one person.
