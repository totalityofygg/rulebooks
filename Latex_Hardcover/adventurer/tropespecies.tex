...
\summary {
    Decide if your Adventurer is \mybold{Mortal} or \mybold{Unseelie}.  If you're Mortal, decide which \mybold{Trope} you want to play: \mypg{Sellsword}{trope-sellsword}, \mypg{Knave}{trope-knave}, \mypg{Philosopher}{trope-philosopher}, or \mypg{Mystic}{trope-mystic}. If you're one of the Unseelie, what decide which \mybold{Species} you are: \mypg{\Murk}{species-murk}, \mypg{Pooka}{species-pooka}, \mypg{Night Child}{species-night-child}, or \mypg{Spriggan}{species-spriggan}.

    \myskip

    Grab the appropriate Trope or Species Character Sheet from \mypg{Appendix F}{appendix-f}, flip to the appropriate section of the book, and follow the creation instructions. Depending on your choices, you'll modify both your sheets -  including writing down your \mypg{Flesh and Grit}{adventurer-flesh-grit}.
}
...
\begin{center}
\includegraphics{adventurer/TropesDetail}
\end{center}


\cbreak

\template{\mybold{The Knave}}
...
\template{\mybold{The Philosopher}}
...
\template{\mybold{The Murk}}  
{"Murks" (as they are more commonly known) are the escaped slaves of the violent and hateful races of the \mypg{Veins of the Earth}{atlas-veins-earth}.  Fallen gods doomed to walk among Mortals, they are forever searching for their way home.  They are often grouped under an epithet \mybold{Rom}, like their cousins the Spriggan. All Murks hail from the Veins of the Earth originally, but they are found throughout the Five Dwarfs near entrances to the Veins.  The horrors they have witnessed (and survived) attunes them to \CLR.}

\template{\mybold{The Night Children}}
...
\template{\mybold{The Pooka}}
{Drug-crazed and thought to be half-lapin, Pooka are widely sought by adventuring Bands for their uncanny good fortune. Pooka are most comfortable around others (Mortal or otherwise), and thus hail from any \mypg{Settlement}{civilization-settlements}.  When they aren't adventuring, they commonly find work as sailors, jesters, scouts, and tavern keepers - but rarely gamblers, since no one will play with them.  Their natural charisma and charm attunes them to \PRE.}



\template{\mybold{The Spriggan}}
{Ex-vassals of the King of Elfland, wandering the Mortal lands trying to find the bright line of Elfland again.  They are able to summon and control \mypg{The Forgotten}{remembrance} - animals, demons, and forgotten gods - and forge legendary \mypg{magical blades}{wonder-sword-magic}.  Like the \Murk they are often called \mybold{Rom}.  All Spriggan hail from Elfland originally, though they can often be found near towns and cities bordering deep forests. Spriggan have "the Sight", a supernaturally attuned \AWA of their surroundings.}
