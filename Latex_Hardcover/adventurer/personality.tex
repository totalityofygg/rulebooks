...
\summary{
    Assign a d4 to each facet of your Personality. This die may be increased depending on your \mybold{Species}.
}
...
Your Personality is a Resource, and is assigned a \UDD{d4} to start. You can tap into aspects of your Personality to Bump a \RO or \RB try that uses a corresponding aspect of your Identity:
...
\examples {
    ...
    You attempt an \mypg{Attack}{combat-attack-action} try while using a \VIG weapon. After rolling and adding your bonuses, your \SUMDICE is 18. You can Bump your roll by trying your \PRE \UD and adding its \SUMDICE to the total (since \PRE augments \VIG). 
}
...
\PRE is the Primary Stat for \mypg{Pooka}{species-pooka}.
...
\TAL is the Primary Stat for \mypg{Night Children}{species-night-child}.
...
\AWA is the Primary Stat for \mypg{Spriggan}{species-spriggan}.
...
\CLR is the Primary Stat for \mypg{Murks}{species-murk}.

\crunch{Exhaustion}{personality-exhausted}

This requires some additional bookkeeping. If one of the facets of your Personality is Spent, you suffer the following ill effects until you gain the appropriate \UD back:
...
\mybullet {
    ...
    \item If your \CLR is exhausted, you are overcome with fear and exhaustion: you take a -4 on all \mypg{Saves}{adventurer-saves}.
}
